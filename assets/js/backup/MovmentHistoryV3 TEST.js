...
function backHistory() {
    ...
    if (selectedobject.action === 'layerName') {
        ...
        document.querySelector(`.layers--group[data-layer="${selectedobject.pageNumber}"] .layers--element[data-layer="${selectedobject.shadesID}"]`).querySelector('.layers--name-space').innerHTML = selectedobject.backstate;
        historyMovIndex--;
        return 'layerName'
    }
    ...
    if (selectedobject.action === 'moveFunction') {
        elementThere.style.left = `${selectedobject['backLeft']}px`;
        elementThere.style.top = `${selectedobject['backTop']}px`;
        historyMovIndex--;
        return 'Move'
    }
    if (selectedobject.action === 'background') {
        selectCanvasContent.style.backgroundColor = selectedobject.backState;
    ...
    if (selectedobject.action === 'bgCreateFunction') {
        removeTemplate(selectedobject);
        historyMovIndex--;
        // selectedobject.action = 'bgDeleteFunction';
        return 'bgCreateFunction'
    }
    if (selectedobject.action === 'bgDeleteFunction') {
        createCanvas();
        historyMovIndex--;
        // selectedobject.action = 'bgCreateFunction';
        return 'bgDeleteFunction'
    }
...
function forwordHistory() {
    ...
    if (selectedobject.action === 'layerName') {
        document.querySelector(`.layers--group[data-layer="${selectedobject.pageNumber}"] .layers--element[data-layer="${selectedobject.shadesID}"]`).querySelector('.layers--name__edit').remove();
        document.querySelector(`.layers--group[data-layer="${selectedobject.pageNumber}"] .layers--element[data-layer="${selectedobject.shadesID}"]`).querySelector('.layers--name-space').innerHTML = selectedobject.forwordstate;
    ...
    if (selectedobject.action === 'moveFunction') {
        elementThere.style.left = `${selectedobject['forwordLeft']}px`;
        elementThere.style.top = `${selectedobject['forwordTop']}px`;
        historyMovIndex++;
        return 'Move'
    }
    if (selectedobject.action === 'background') {
        selectCanvasContent.style.backgroundColor = selectedobject.forwordState;
